...
public class NLAction {
    ...
    public boolean isCrash() {
        ...
        return isOBAction() && (this.actionNegated == null || !this.actionNegated) && containsCrashInfo();
    }

    public boolean containsCrashInfo() {
        return ("crash".equalsIgnoreCase(action)
    ...
    public boolean isEBAction() {
        return ActionType.EB.equals(this.type);
    }
}
