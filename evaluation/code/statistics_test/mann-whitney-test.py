...
def compute_mann_whiteney():
    ...
    res_ob_1 = mannwhitneyu(res_ob_burt, res_ob_itrac, alternative="less", method="auto")

    print(res_ob_1)

    res_eb_1 = mannwhitneyu(res_eb_burt, res_eb_itrac, alternative="less", method="auto")
