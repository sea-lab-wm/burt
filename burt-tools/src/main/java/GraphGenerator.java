...
public class GraphGenerator {
    ...
    public AppGraphInfo generateGraph(EntityManager em, String packageApp, String version) throws Exception {
        AppDao appDao = new AppDao();
        App app = appDao.getUniqueByPackage(packageApp, version, em);
        if (app != null) {
            return generateGraph(app);
        }
        return null;
