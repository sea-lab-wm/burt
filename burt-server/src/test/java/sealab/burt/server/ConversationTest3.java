 ...
 * [Hi, send selected app, yes(confirm app selection), provide OB, done(select OB screenshots), provide EB, provide the first step, done(select S2R screen to disambiguate), ]
 */
public class ConversationTest3 extends AbstractTest{
...
//    }
    ...
    @org.junit.Test
    @DisplayName("select S2R screen to disambiguate")
    public void testK() throws Exception {

        MESSAGE.setMessages(Collections.singletonList(new MessageObj("done",   S2R_SCREENS)));
