 ...
 * [Hi, send selected app, yes(confirm app selection), provide OB, none of above(deny OB screenshots), done(confirm OB screenshot), provide EB, provide the first step]
 */

public class ConversationTest2 extends AbstractTest{
    ...
    public void testF() throws Exception {
        int code = sendAffirmativeOrNegativeAnswer("none of above");
        assertNotEquals(-1,code);
    }
