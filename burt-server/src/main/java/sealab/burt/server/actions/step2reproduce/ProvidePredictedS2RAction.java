...
public class ProvidePredictedS2RAction extends ChatbotAction {
    ...
    public MessageObj execute(ConcurrentHashMap<String, Object> state) {
        return new MessageObj(" Ok, it seems the next steps that you performed are the following. Can you confirm which are correct? Please click the “done” button when you are done.");
