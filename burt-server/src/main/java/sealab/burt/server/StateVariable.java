...
public enum StateVariable {
    ...
    //s2r variables
    COLLECTING_S2R, CONFIRM_LAST_STEP, DISAMBIGUATE_S2R, S2R_ALL_MISSING, PREDICTING_S2R,
    PREDICTED_S2R_NUMBER_OF_PATHS, PREDICTED_S2R_PATHS_WITH_LOOPS, PREDICTED_S2R_CURRENT_PATH,
    NON_SELECTED_PREDICTED_S2R, S2R_MATCHED_CONFIRMATION, S2R_MATCHED_MSG, COLLECTING_FIRST_S2R,
