        ...
        <div className="tips-quick-answers">
            <div className="quick-answers">
                ...
                <div className="button-lists">
                    <button type="button" className="btn btn-primary btn-sm" onClick={restartConversation} >Restart the conversation</button>
                    <button type="button" className="btn btn-success btn-sm" onClick={finishS2R} >I am done reporting</button>
                    <button type="button" className="btn btn-warning btn-sm" onClick={previewReport} >View the bug report</button>
                </div>
            </div>
            <div className="tips">
                <h6 className="h6-tips">
